...
extern inline int PassContentsToClient(request_rec *r, void* Data, int DataSize, HANDLE* HStdOut, HANDLE* HStdErr, OutputHeaderResults *OHR);
extern inline int PreapreProcess(request_rec *r, STARTUPINFO* si, HANDLE *HStdOut, HANDLE *HStdIn, HANDLE *HStdErr, char **ScriptCommand);
